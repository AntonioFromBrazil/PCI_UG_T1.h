Para facilitar o desenvolvimento de aplicações a serem hospedadas na placa PCI_UG_T1, foi criada uma biblioteca de mesmo nome (PCI_UG_T1.h), disponível em https://github.com/AntonioFromBrazil/PCI_UG_T1 a qual dispõe das seguintes funções:
...
comando construtor que deve ser informado logo após o include, sendo t0, t1 variáveis do tipo uint8_t que definem o tipo de motor conectado a CN1 e CN2, sendo possível os seguintes valores:
...
comando que ativa o motor de passo, de forma automática e não bloqueante, conforme as seguintes variáveis:
...
-----------------------------------------------------------------------------------------
x.runDC(n, time, veldc, wdc);

comando que ativa o motor DC, de forma automática e não bloqueante, conforme as seguintes variáveis:
...
Se	n=1,	o motor DC deverá estar conectado aos pinos 3 e 4 do CN1 ou do CN7.
Se	n=2,	o motor DC deverá estar conectado aos pinos 1 e 2 do CN2 ou do CN6.
Se	n=3,	o motor DC deverá estar conectado aos pinos 3 e 4 do CN2 ou do CN6.
...
comando que ativa a emissão de beeps sonoros, de forma automática e não bloqueante, conforme as seguintes variáveis:
...
comando que ativa piscadas do Led, de forma automática e não bloqueante, conforme as seguintes variáveis:
...
esta função retorna no formato uint32_t o estado atual do contador de milisegundos previamente inicializado pelo comando nomex.setms. Serve como alternativa para a função delay(), de forma não bloqueante
...
x.linter - duração Led apagado (ms)
...
//contagem de 4 segundos, de forma não bloqueante
//via chamada convencional:  
